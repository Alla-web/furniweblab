...
`;const ee=document.querySelector(".swiper .swiper-wrapper");function te(e){if(e==null)return"";const o=Math.round(e*2)/2,t=Math.floor(o),r=o-t===.5;let n=`rating value-${t}`;return r&&(n+=" half"),`
    ...
    `,document.body.appendChild(e),document.body.classList.add("no-scroll")}function S(){const e=document.getElementById("page-spinner");e&&(e.remove(),document.body.classList.remove("no-scroll"))}u.defaults.baseURL="https://furniture-store-v2.b.goit.study/api";function R(e){d.error({message:e,position:"topCenter",timeout:3e3,backgroundColor:"#EF4040",messageColor:"white",close:!1})}async function re(e){try{return(await u.get(`/furnitures/${e}`)).data}catch(o){throw console.error(`Помилка при отриманні деталей продукту з ID ${e}:`,o),o}}const L=document.querySelector(".product-modal-backdrop"),F=document.querySelector(".product-modal .modal-main-content"),ne=document.querySelector(".modal-close-btn"),j=document.body;function se(e){if(e==null)return"";const o=Math.round(e*2)/2,t=Math.floor(o),r=o-t===.5;let n=`rating value-${t}`;return r&&(n+=" half"),`
        <div class="${n}">
            <div class="star-container"></div>
        </div>
